...
class ConfigProviderCc extends \VirtusPay\Magento2\Model\ConfigProvider implements ConfigProviderInterface
{
    ...
    {
        $asset = $this->ccConfig
                    ->createAsset('VirtusPay_Magento2::images/cc/cvv.gif');
        return $asset->getUrl();
    }
    public function getSingleIcon()
    {
        $asset = $this->ccConfig
            ->createAsset('VirtusPay_Magento2::images/cc/bandeiras-checkout3.png');
    ...
    public function getIcons()
    {
        ...
        foreach (array_keys($types) as $code) {
            ...
            if (!array_key_exists($code, $this->icons)) {
                $asset = $this->ccConfig
                    ->createAsset('VirtusPay_Magento2::images/cc/' . strtolower($code) . '.png');
